...
JNIEXPORT jint JNICALL
Java_com_example_cryptapp_MainActivity_encryptor_1encryptFile(JNIEnv *env, jobject thiz,
...
JNIEXPORT jint JNICALL
Java_com_example_cryptapp_MainActivity_encryptor_1decryptFile(JNIEnv *env, jobject thiz,
                                                            jstring filename, jstring new_filename,
                                                            jstring iv) {
